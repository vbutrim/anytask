...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DefaultTeacher'
        db.create_table('courses_defaultteacher', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('teacher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, db_index=False)),
        ...
        db.send_create_signal('courses', ['DefaultTeacher'])


    def backwards(self, orm):
        # Deleting model 'DefaultTeacher'
        db.delete_table('courses_defaultteacher')
    ...
    models = {
        ...
        'courses.defaultteacher': {
            'Meta': {'object_name': 'DefaultTeacher'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.Course']", 'null': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['groups.Group']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'teacher': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'db_index': 'False'})
        },
