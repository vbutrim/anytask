...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.information_html'
        db.add_column('courses_course', 'information_html',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.information_html'
        db.delete_column('courses_course', 'information_html')
    ...
    models = {
        ...
        'courses.course': {
            ...
            'information_html': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
